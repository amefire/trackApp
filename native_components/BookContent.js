...
export default function BookContent() {
  ...
  useEffect(() => {
    const loadFiles = async () => {
      try {
        const sentences = await RNFS.readFile(`${RNFS.DocumentDirectoryPath}/book_sentences.json`);
        ...
        const utterancesContent = await RNFS.readFile(`${RNFS.DocumentDirectoryPath}/utterances.json`);
        ...
        await RNFS.writeFile(`${RNFS.DocumentDirectoryPath}/book_sentences.json`, JSON.stringify(bookSentencesWithRead));
